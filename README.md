...
### Further Reading
For more on running the SCAN model and interpreting the results, as well as motivating and contextualizing the project, see the included report, [Semantic Change in the Technical Terms of Victorian Logic](https://github.com/janeumanIU/VictorianLogic/blob/master/misc/Neumann_Semantic_Change_in_Victorian_Logic_2020.pdf).
